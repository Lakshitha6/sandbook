...
export default function SignUp() {
  ...
  async function handleSubmit(event) {
    ...
    setLoading(true);
     ...
     try {
const response = await fetch('https://2d8042b8-0a21-4a70-a1e4-332303ca9cde-dev.e1-us-east-azure.choreoapis.dev/sandbook-social-media/backend/v1.0/createUser', {
  method: 'POST',
  headers: {
